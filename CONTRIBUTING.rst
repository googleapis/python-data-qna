...
- While logged into your GitHub account, navigate to the
  ``python-data-qna`` `repo`_ on GitHub.

- Fork and clone the ``python-data-qna`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-data-qna`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-data-qna``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-data-qna.git hack-on-python-data-qna
   $ cd hack-on-python-data-qna
...
.. _repo: https://github.com/googleapis/python-data-qna
