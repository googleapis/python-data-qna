...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (QuestionServiceAsyncClient, transports.QuestionServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class", [
    QuestionServiceClient, QuestionServiceAsyncClient
])
@mock.patch.object(QuestionServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(QuestionServiceClient))
@mock.patch.object(QuestionServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(QuestionServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (QuestionServiceClient, transports.QuestionServiceGrpcTransport, "grpc", grpc_helpers),
    (QuestionServiceAsyncClient, transports.QuestionServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
