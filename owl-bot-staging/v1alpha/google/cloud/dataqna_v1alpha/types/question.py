...
class Question(proto.Message):
    ...
    interpret_error = proto.Field(proto.MESSAGE, number=5,
        message='InterpretError',
    )

    interpretations = proto.RepeatedField(proto.MESSAGE, number=6,
    ...
    debug_flags = proto.Field(proto.MESSAGE, number=9,
        message='DebugFlags',
    )

    debug_info = proto.Field(proto.MESSAGE, number=10,
        message=gp_any.Any,
    )
...
class InterpretError(proto.Message):
    ...
    class InterpretErrorDetails(proto.Message):
        ...
        unsupported_details = proto.Field(proto.MESSAGE, number=1,
            message='InterpretError.InterpretUnsupportedDetails',
        )

        incomplete_query_details = proto.Field(proto.MESSAGE, number=2,
            message='InterpretError.InterpretIncompleteQueryDetails',
        )

        ambiguity_details = proto.Field(proto.MESSAGE, number=3,
    ...
    class InterpretIncompleteQueryDetails(proto.Message):
        ...
        entities = proto.RepeatedField(proto.ENUM, number=1,
    ...
    code = proto.Field(proto.ENUM, number=2,
...
class ExecutionInfo(proto.Message):
    ...
    job_creation_status = proto.Field(proto.MESSAGE, number=1,
        message=status.Status,
    )

    job_execution_state = proto.Field(proto.ENUM, number=2,
    ...
    bigquery_job = proto.Field(proto.MESSAGE, number=4,
        message='BigQueryJob',
    )
...
class Interpretation(proto.Message):
    ...
    human_readable = proto.Field(proto.MESSAGE, number=4,
        message='HumanReadable',
    )

    interpretation_structure = proto.Field(proto.MESSAGE, number=5,
        message='InterpretationStructure',
    )

    data_query = proto.Field(proto.MESSAGE, number=6,
        message='DataQuery',
    )

    execution_info = proto.Field(proto.MESSAGE, number=7,
...
class HumanReadable(proto.Message):
    ...
    generated_interpretation = proto.Field(proto.MESSAGE, number=1,
        message=annotated_string.AnnotatedString,
    )

    original_question = proto.Field(proto.MESSAGE, number=2,
        message=annotated_string.AnnotatedString,
    )
...
class InterpretationStructure(proto.Message):
    ...
    visualization_types = proto.RepeatedField(proto.ENUM, number=1,
        enum=VisualizationType,
    )

    column_info = proto.RepeatedField(proto.MESSAGE, number=2,
        message=ColumnInfo,
    )
