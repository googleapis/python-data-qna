...
class SuggestQueriesRequest(proto.Message):
    ...
    suggestion_types = proto.RepeatedField(proto.ENUM, number=4,
        enum='SuggestionType',
    )
...
class Suggestion(proto.Message):
    ...
    suggestion_info = proto.Field(proto.MESSAGE, number=1,
        message='SuggestionInfo',
    )

    ranking_score = proto.Field(proto.DOUBLE, number=2)

    suggestion_type = proto.Field(proto.ENUM, number=3,
        enum='SuggestionType',
    )
...
class SuggestionInfo(proto.Message):
    ...
    annotated_suggestion = proto.Field(proto.MESSAGE, number=1,
        message=annotated_string.AnnotatedString,
    )

    query_matches = proto.RepeatedField(proto.MESSAGE, number=2,
        message=MatchInfo,
    )
