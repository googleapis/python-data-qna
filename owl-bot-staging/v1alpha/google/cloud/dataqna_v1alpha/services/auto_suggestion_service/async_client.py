...
class AutoSuggestionServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(AutoSuggestionServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(AutoSuggestionServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(AutoSuggestionServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(AutoSuggestionServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(AutoSuggestionServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(AutoSuggestionServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(AutoSuggestionServiceClient.common_project_path)
    parse_common_project_path = staticmethod(AutoSuggestionServiceClient.parse_common_project_path)
    common_location_path = staticmethod(AutoSuggestionServiceClient.common_location_path)
    parse_common_location_path = staticmethod(AutoSuggestionServiceClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(AutoSuggestionServiceClient).get_transport_class, type(AutoSuggestionServiceClient))
    ...
    async def suggest_queries(self,
            request: Optional[Union[auto_suggestion_service.SuggestQueriesRequest, dict]] = None,
            *,
