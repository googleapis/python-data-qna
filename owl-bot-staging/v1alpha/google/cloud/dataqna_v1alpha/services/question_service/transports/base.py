...
class QuestionServiceTransport(abc.ABC):
    ...
    @property
    def get_question(self) -> typing.Callable[
            [question_service.GetQuestionRequest],
            typing.Union[
                question.Question,
                typing.Awaitable[question.Question]
            ]]:
        raise NotImplementedError()

    @property
    def create_question(self) -> typing.Callable[
            [question_service.CreateQuestionRequest],
            typing.Union[
                gcd_question.Question,
                typing.Awaitable[gcd_question.Question]
            ]]:
        raise NotImplementedError()

    @property
    def execute_question(self) -> typing.Callable[
    ...
    @property
    def get_user_feedback(self) -> typing.Callable[
            [question_service.GetUserFeedbackRequest],
            typing.Union[
                user_feedback.UserFeedback,
                typing.Awaitable[user_feedback.UserFeedback]
            ]]:
        raise NotImplementedError()

    @property
    def update_user_feedback(self) -> typing.Callable[
